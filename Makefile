...
test-unit:
	$(PYTHON) pytest tests/test_app.py tests/test_application_policies.py tests/test_eligibility.py tests/test_image_imports.py tests/test_review_forms.py tests/test_review_state.py tests/test_scanned_pdf_imports.py tests/test_score_calculation.py tests/test_score_conversion.py tests/test_score_inputs.py tests/test_score_rule_schema.py tests/test_score_selection.py tests/test_structured_imports.py tests/test_temporary_uploads.py tests/test_text_pdf_imports.py tests/test_validate_rules.py
