...
test-unit:
	$(PYTHON) pytest tests/test_app.py tests/test_image_imports.py tests/test_structured_imports.py tests/test_temporary_uploads.py tests/test_text_pdf_imports.py tests/test_validate_rules.py
