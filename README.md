...
현재 상태는 **Phase 8: 상담 UI·A4 출력 진행 중**입니다. Phase 7까지 규칙 생명주기·관리자 검수·CSV DRAFT·직접 편집 계약을 완료했습니다. 자격이 확인된 전형에만 게시 규칙으로 성적을 계산하며, 과거 입시결과는 같은 연도와 당시 규칙 버전이 연결된 게시 자료만 상담 비교에 사용합니다.
