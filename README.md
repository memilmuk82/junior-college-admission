...
현재 상태는 **Phase 2: 입력 게이트웨이 진행 중**입니다. PostgreSQL 기반 위에 CSV·표 붙여넣기·XLSX·텍스트 PDF·PNG/JPEG·클립보드·이미지형 PDF 미리보기와 확인 행 저장·원본 삭제 계약까지 제공하며, 교사 검수 화면·전형 판정·점수 계산 기능은 아직 제공하지 않습니다.
