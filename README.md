...
현재 상태는 **Phase 4: 성적 계산 엔진 진행 중**입니다. 자격이 확인된 전형에만 게시 규칙으로 원적교·위탁기관 성적 범위를 선택하고, 검증된 학기·과목·가중치·Z점수 변환과 제외 이유를 버전 trace로 제공합니다. 실제 대학 산식과 환산점수는 공식 근거·사람 승인·골든 테스트가 준비되기 전까지 제공하지 않습니다.
