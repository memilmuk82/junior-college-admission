...
현재 상태는 **Phase 8: 상담 UI·A4 출력 완료**입니다. 관리자 인증 뒤 단계형 학생 사실 입력, 지원자격 우선 판정, 허용 전형의 성적 계산, 규칙 버전이 고정된 게시 입시결과 비교, 학생용·교사용 A4 출력을 제공합니다. 과거 입시결과의 학년도나 규칙 버전이 다르면 수치 자료는 참고로만 표시하고 직접 비교하지 않습니다. 다음 게이트는 Phase 9 BYOK AI입니다.
