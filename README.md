...
현재 상태는 **Phase 2: 입력 게이트웨이 완료**입니다. PostgreSQL 기반 위에 CSV·표 붙여넣기·XLSX·텍스트 PDF·PNG/JPEG·클립보드·이미지형 PDF 미리보기와 교사 검수·행 수정·선택 확정·원본 삭제 계약을 제공합니다. 지원자격 판정과 점수 계산 기능은 아직 제공하지 않습니다.
