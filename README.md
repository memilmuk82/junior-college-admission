...
Phase 13 상담은 학생 사실과 성적을 한 번 준비한 뒤 여러 대학·캠퍼스·학과를 체크합니다. 서버가 각 학과의 해당 학년도 전형을 모두 확장해 지원자격을 독립 판정하고, 허용된 전형마다 대학별 반영 평균등급과 같은 척도로 검증된 공개 평균등급을 한 화면과 학생용·교사용 A4에 표시합니다. 공개 데모는 실제 대학 규칙이 아닌 복수 가상 대학·학과·전형 자료만 사용합니다.
