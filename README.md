...
현재 상태는 **Phase 10: 대상 대학 확대·운영**입니다. Phase 8의 지원자격 우선 판정·결정론적 성적 계산·입시결과 비교·학생용/교사용 A4는 AI 키 없이 그대로 동작합니다. Phase 9의 OpenAI smoke는 통과했고 Gemini·Anthropic 키는 후속 적용 대상으로 보류합니다. Phase 10에서는 대학 5곳 단위 확대, 최종 모집요강 교체, 성능·보안·백업·복구와 합성 현장 파일럿을 진행합니다.
