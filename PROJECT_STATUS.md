...
- 기준일: 2026-07-12
- 현재 단계: Phase 3 지원자격 판정 엔진 진행 중
- 단계 판정: IN_PROGRESS
- 현재 작업: 학생 사실 모델·제한형 DSL·5개 상태·설명 trace 코어
- 다음 게이트: 복수지원·결격 규칙 분리 및 기존 규칙 저장소 연결
...
- [ ] 복수지원 규칙과 지원자격의 독립 판정
- [ ] 민감 결격 규칙의 비영구 입력 계약
- [ ] PostgreSQL 게시 규칙 조회·판정 서비스 연결
